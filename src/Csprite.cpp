...
Csprite::Csprite(const char *dessin,const char *colormask, COLORS defaultcolor, int depth, int sens, char*comment)
{
    m_height= m_width = -1;
...
Csprite::Csprite(const char **dessin, int nbshape, const char *colormask, COLORS defaultcolor, int depth, int sens, char*comment)
{
    m_height= m_width = -1;
...
void Csprite::init_sprite(const char **dessin, int nbshape,const char *colormask, COLORS defaultcolor, int depth, int sens)
{
    clear_m_shape();
...
void Csprite::init_sprite(const char *dessin,const char *colormask, COLORS defaultcolor, int depth, int sens)
{
    init_sprite(&dessin, 1,colormask, defaultcolor, depth, sens);
}
void Csprite::init_sprite(vector<CChaine*> &shape,const char *colormask, COLORS defaultcolor, int depth, int sens)
{
...
{
    //init_sprite(src->m_shape.getstr(),src->m_colormask.getstr(), src->m_defaultcolor, src->m_depth);
